...
const TradingViewChart = () => {
  ...
  useEffect(() => {
    ...
    const series = [
      ...
      ...(showVolume ? [{
        ...
        type: 'bar',
        data: volumeData,
        color: colors.bar // apply bar color
      }] : [])
    ];
    ...
    const options = {
      ...
      annotations: {
        xaxis: [
          {
            x: new Date(1538784000000).getTime(), // Start
            x2: new Date(1538789400000).getTime(), // End
            fillColor: '#ff0000',
            opacity: 0.2,
            label: {
              text: 'Highlighted Zone 1',
              style: {
                color: '#fff',
                background: '#ff0000'
              }
          ...
          {
            x: new Date(1538802000000).getTime(),
            x2: new Date(1538807400000).getTime(),
            fillColor: '#00ff00',
            opacity: 0.2,
            label: {
              text: 'Zone 2',
  ...
  }, [symbol, showVolume, colors]);
  console.log("Candlestick colors:", colors);
    ...
    <div style={{ width: "100%", color: "#fff", padding: "0px" }}>
      <div className="select-symbol" style={{ marginBottom: "15px" }}>
        ...
        <Button
          ...
          variant="outlined"
          style={{ marginLeft: "10px", color: "#fff", borderColor: "#fff" }}
        >
          Settings
        </Button>
      ...
      <Dialog open={settingsOpen} onClose={() => setSettingsOpen(false)}>
        <DialogTitle>Chart Display Settings</DialogTitle>
        <DialogContent>
          <TextField
            label="Upward Candle Color"
            type="color"
            value={colors.upward}
            onChange={(e) => setColors({ ...colors, upward: e.target.value })}
            fullWidth
            margin="normal"
          />
          <TextField
            label="Downward Candle Color"
            type="color"
            value={colors.downward}
            onChange={(e) => setColors({ ...colors, downward: e.target.value })}
            fullWidth
            margin="normal"
          />
          <TextField
          ...
          <TextField
            ...
            type="color"
            value={colors.grid}
            onChange={(e) => setColors({ ...colors, grid: e.target.value })}
            fullWidth
            margin="normal"
          />
          <TextField
            label="Volume Bar Color"
            type="color"
            value={colors.grid}
            onChange={(e) => setColors({ ...colors, bar: e.target.value })}
            fullWidth
            margin="normal"
          />
          <TextField
          ...
          />
          <TextField
            label="Candle Outline Color"
            type="color"
            value={colors.candleLine || '#666'}
            onChange={(e) => setColors({ ...colors, line: e.target.value })}
            fullWidth
            margin="normal"
          />
